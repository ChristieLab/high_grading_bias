...
cryptic <- readRDS("../results/pca_cryptic.RDS")
...
```
# Figure 3: Outlier tests

We do F3 here as well since some of the PCAs produced above are used again.
...
cairo_pdf("../results/Figure3.pdf", width = 7, height = 7)
Figure3
dev.off()
```
