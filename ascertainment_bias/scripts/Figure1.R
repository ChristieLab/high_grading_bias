...
p_rubias_all <- ggplot(rubias_all) +
  ...
  labs(x= "Randomly Assigned Population",  y="Prop. of Individuals Assigned") +
...
figure_1 <- plot_grid(
  ...
  structure_allsnps$plot + 
    ...
    theme(axis.text = element_text(angle=0, size=18), 
  ...
  btm_lg,
  ncol = 3, axis = "tr", align="hv", rel_widths =c(1,1,.42)
)
figure_1
save_plot("~/assignment_tests/ascertainment_bias/figures/fig1.svg", figure_1,  base_height = 11, base_width = 15)
