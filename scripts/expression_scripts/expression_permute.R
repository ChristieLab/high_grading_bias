### High Grading Bias in expression data 
### permute 100x 
...
treatment <- sample(LETTERS[1:2], 30, FALSE)
...
# paste0("/scratch/negishi/lee3617/ascertainment_bias/results/deseq_permute_res_", iter, ".RDS"